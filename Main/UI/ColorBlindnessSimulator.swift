...
struct ColorBlindnessSimulator: View {
    ...
    var body: some View {
        // Your content here, with color adjustments based on the simulation
        // For example, you can use Color.red, Color.green, Color.blue, etc.
        // Apply color adjustments conditionally based on the simulation settings
        VStack {
